<template>
  <div class="m-4">
    ...
    <div v-if="balance.eth !== null || pending">
      <div v-if="!pending">Balance: {{ balance.eth }} ETH</div>
...
watch(date, async (newDate) => {
  ...
  balance.value.eth = parseFloat(result) * Math.pow(10, -18);
  pending.value = false;
});
</script>
